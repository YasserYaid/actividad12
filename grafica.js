...
// Se arma el objeto con los arreglos de datos, colores y borders que requiere el gráfico
const data = {
    labels : labels,
    datasets : [{
...
// Se arma el objeto de configuracion que requiere el gráfico
const config = {
    type : 'bar',
    data : data,
...
//Se construye el grafico en el canvas
